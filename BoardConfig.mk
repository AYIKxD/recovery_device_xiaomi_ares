...
PB_INCLUDE_CRYPTO_FBE := true
BOARD_USES_METADATA_PARTITION := true
PB_INCLUDE_FBE_METADATA_DECRYPT := true

# Hack: prevent anti rollback
PLATFORM_SECURITY_PATCH := 2927-12-31
...
PB_DEFAULT_BRIGHTNESS := 1200
PB_DEVICE_VERSION := by AYIKxD
...
PB_MAX_BRIGHTNESS := 2047
PB_SCREEN_BLANK_ON_BOOT:= true
PB_THEME := portrait_hdpi
PBRP_INCLUDE_LOGCAT := true
PB_OF_MAINTAINER="ツ๛abrohim๛"

# StatusBar
PB_STATUS_ICONS_ALIGN := center
PB_CUSTOM_CPU_POS := "210"
PB_CUSTOM_CLOCK_POS := "40"
PB_CUSTOM_BATTERY_POS := "790"
